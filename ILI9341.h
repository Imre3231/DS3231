...
#define TFT_RD_pin        LATDbits.LATD6  //
//#define TFT_CS_pin      LATDbits.LATD2       //   
#define TFT_RST_pin       LATBbits.LATB6       //
#define TFT_RS_pin        LATDbits.LATD8     //
#define TFT_WR_pin        LATBbits.LATB5       //

#define TFT_Data_pin0     LATCbits.LATC10 
#define TFT_Data_pin1     LATBbits.LATB7 
#define TFT_Data_pin2     LATCbits.LATC13 
#define TFT_Data_pin3     LATBbits.LATB8 
#define TFT_Data_pin4     LATBbits.LATB9 
#define TFT_Data_pin5     LATCbits.LATC6 
#define TFT_Data_pin6     LATCbits.LATC7 
#define TFT_Data_pin7     LATCbits.LATC8 
...
void TFT_data_out_port(unsigned char data);
...
void TFT_data_out_port(unsigned char data)
{
    ...
    unsigned char i();
            ...
            TFT_Data_pin0=((data>>0)&0x01);
            TFT_Data_pin1=((data>>1)&0x01); 
            TFT_Data_pin2=((data>>2)&0x01);
            TFT_Data_pin3=((data>>3)&0x01);
            TFT_Data_pin4=((data>>4)&0x01);
            TFT_Data_pin5=((data>>5)&0x01);
            TFT_Data_pin6=((data>>6)&0x01);
            TFT_Data_pin7=((data>>7)&0x01);
...
{
    TFT_RS_pin = 0;
    data_port = ((command) & 0x00ff);
    TFT_data_out_port(data_port);
    TFT_WR_pin = 0;                        // WRITE ON RISE
    TFT_WR_pin = 1;                 
}
